...
echo -e " $COLOR1 $NC   ${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}INSTALAR HELIUM   ${WH}[${COLOR1}12${WH}]${NC} ${COLOR1}• ${WH}MENU HELIUM"
echo -e " $COLOR1 $NC   ${WH}[${COLOR1}13${WH}]${NC} ${COLOR1}• ${WH}BOT SSH           ${WH}[${COLOR1}14${WH}]${NC} ${COLOR1}• ${WH}X PENDIENTE"
#echo -e " $COLOR1 $NC"
...
08 | 8) clear ; mspeed ;;
09 | 9) clear ; hidessh ;;
10 | 10) clear ; regionchecker ;;
11 | 11) clear ; rm -rf /usr/local/sbin/helium && wget -q -O /usr/local/sbin/helium https://raw.githubusercontent.com/abidarwish/helium/main/helium.sh && chmod +x /usr/local/sbin/helium && helium ;;
12 | 12) clear ; helium ;;
13 | 13) clear ; wget https://raw.githubusercontent.com/givpn/AutoScriptXray/master/bot%20telegram%20panel/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh ;;
14 | 14) clear ; m-vless ;;
99 | 99) clear ; bot ;;
100 | 100) clear ; add-bot-panel ;;
00 | 0) clear ; menu ;;
*) clear ; menu-set ;;
esac
