...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1 $NC   ${WH}[${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}CADA 10 MINUTOS ${WH}[${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}EVERY DAY $COLOR1 $NC"
echo -e " $COLOR1 $NC   ${WH}[${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}CADA HORA       ${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}EVERY WEEK    $COLOR1 $NC"
echo -e " $COLOR1 $NC                                               $COLOR1 $NC"
echo -e " $COLOR1 $NC   ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}ESTADO DE RESPALDO$status2 $status3"
echo -e " $COLOR1 $NC                                               $COLOR1 $NC"
